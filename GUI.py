...
class Login(Frame):
    ...
    def init_window(self):
        ...
        # self.master.iconbitmap("~/Coding/Python/python\ gui\ project/blood/Blood.ico")
        ...
        self.img = img = PhotoImage(file='blood_logo.png')
        ...
        self.er = Button(self, text="Report", font=("Helvetica", 12), fg='red', relief=SUNKEN)
        self.er.place(x=800, y=575)
    ...
    def gen_form(self):
        root.destroy()
        os.system('python report_generation.py')
    ...
    def imagesel1(self):
        ...
        if v == 4:
            ...
            if self.ep["relief"] == "raised":
             self.er.configure(relief=RAISED, fg='green',command=self.gen_form)
