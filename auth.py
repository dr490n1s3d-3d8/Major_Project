...
ws = Tk()
ws.title('Blood Type Detection Using Image Processing')
ws.geometry('500x400')
ws.config(bg="#447c84")
...
# button 
clr = Button(frame, text="Clear", padx=20, pady=10, relief=SOLID, font=("Times", "12", "bold"), command=clr)
reg = Button(frame, text="Register", padx=20, pady=10, relief=SOLID, font=("Times", "12", "bold"), command=submit)
ext = Button(frame, text="Exit", padx=20, pady=10, relief=SOLID, font=("Times", "12", "bold"), command=lambda:ws.destroy())
login = Button(frame, text="Login", padx=20, pady=10, relief=SOLID, font=("Times", "12", "bold"), command=lambda:(ws.destroy(),os.system("python app.py")))
...
login.grid(row=7, column=1, pady=20)
